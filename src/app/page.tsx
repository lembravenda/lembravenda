    ...
    <main className="overflow-x-hidden">
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-14 px-5 pb-20 pt-16 md:grid-cols-[1.15fr_0.85fr] md:gap-20 md:px-10 md:pb-32 md:pt-24">
          ...
          <div>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              ...
              <Link
                className="lv-button-secondary h-14 rounded-2xl px-7 text-sm font-semibold"
                href="#como-funciona"
              >
                Ver como funciona
              </Link>
      ...
      >
        <div className="mb-14 max-w-lg">
          ...
          <h2
            className="mt-4 text-3xl font-semibold leading-[1.22] tracking-[-0.02em] text-foreground md:text-[2.5rem]"
            id="problema-title"
          >
      ...
      >
        <div className="mx-auto grid max-w-6xl items-center gap-14 px-5 py-20 md:grid-cols-2 md:gap-20 md:px-10 md:py-32">
          ...
          <div>
            ...
            <h2
              className="mt-4 text-3xl font-semibold leading-[1.2] tracking-[-0.02em] text-white md:text-[2.5rem]"
              id="solucao-title"
            >
      ...
      >
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            <div
              className="group relative rounded-2xl bg-surface p-7 shadow-card transition hover:shadow-md"
              key={step.num}
            >
              <span className="text-4xl font-bold tracking-tighter text-primary/12 select-none">
                {step.num}
              </span>
          ...
          <div className="grid gap-3.5 sm:grid-cols-2 md:grid-cols-3">
            {[
              ...
              >
                ...
                <p className="mt-1.5 text-xs leading-[1.65] text-text-secondary">
                  {desc}
                </p>
              </div>
            ))}
      ...
      >
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {[
            ...
            <div
              className="flex flex-col justify-between rounded-2xl bg-surface p-7 shadow-card"
              key={name}
            >
              {/* stars */}
              <div>
                ...
                <p className="mt-4 text-sm leading-[1.8] text-foreground">
                  &ldquo;{quote}&rdquo;
                </p>
              </div>
      ...
      <section
        ...
        className="mx-auto max-w-6xl px-5 pb-20 md:px-10 md:pb-32"
        id="preco"
      >
        <div className="overflow-hidden rounded-3xl bg-green-section px-8 py-12 md:px-14 md:py-16">
          <div className="grid gap-12 md:grid-cols-[1fr_auto] md:items-center">
            ...
            <div className="flex flex-col items-start gap-5 md:items-center">
              ...
              <Link
                className="inline-flex h-14 items-center justify-center gap-2 whitespace-nowrap rounded-2xl bg-white px-9 text-sm font-bold text-primary transition hover:bg-primary-lighter"
                href="/login"
              >
                Criar conta grátis
                <ArrowRightIcon className="h-4 w-4" />
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {[
              ...
              },
              {
                ...
                a: "Não. O LembraVenda deixa a mensagem pronta para você copiar e enviar quando quiser — você controla o contato."
              },
              {
              ...
              <div
                className="rounded-xl border border-border bg-background p-5 transition hover:border-border-strong"
                key={q}
              >
